...
public class BattleBoardController {
    ...
    public void setBinding() {
        playerOneHealthBar.progressProperty().bind(mainApp.getPlayerOne().healthPercProperty());
        playerTwoHealthBar.progressProperty().bind(mainApp.getPlayerTwo().healthPercProperty());
        playerOneManaBar.progressProperty().bind(mainApp.getPlayerOne().manaPercProperty());
        playerTwoManaBar.progressProperty().bind(mainApp.getPlayerTwo().manaPercProperty());
